## Same but we implement a hardcoded first move and swap policy
...
class mctsAgent0():
    ...
    def run(self):
        ...
        self._swaps = [(8,1),(2,9),(6,4),(4,6),(4,3),(6,7)]
        self._first_move = (8,1)
    ...
    def _make_move(self):
        ...
        # We are first - play first move from book
        if (self._turn_count == 1):
            move = self._ij(self._first_move)
            msg = f"{move[0]},{move[1]}\n"

        # We are second - check if last move was one of our swaps
        elif(self._turn_count == 2 and self._ij(self._last_move) in self._swaps):
            msg = "SWAP\n"
